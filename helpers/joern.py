...
def run_joern(filepath: str, verbose: int):
    ...
    joern_bin_path = "/data/zlwang/joern-cli/joern"
    command = f"{joern_bin_path} --script {script_file} --params='{params}'"
    print("Running command:", command)
    output = utils.subprocess_cmd(command, verbose=3)
    print("Joern output:", output)
